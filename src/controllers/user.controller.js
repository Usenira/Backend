...
const generateAccessAndRefreshTokens = async (userId) => {
  try {
    ...
    throw new ApiError(500, "Something went wrong while generating refresh and sccess token")
  }
}
...
const updateCoverImage = asyncHandler(async(req, res) => {
  ...
  const oldCoverImage = req.user?.avatar.url;
...
const getUserChannelProfile = asyncHandler(async(req,res) => {
  ...
  return res.status(200).json( new ApiResponse(200,channel[0], "User channe fetched Successfully"))
})
